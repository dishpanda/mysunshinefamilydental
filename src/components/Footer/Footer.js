      ...
      <Container>
        <div className="flex-container">
          <div>
            ...
            <p>
              <small>
                &copy; {new Date().getFullYear()} Sunshine Family Dental <br />
          ...
          <div>
            ...
            <ul class="list-unstyled">
              <li><a href="/mysunshinefamilydental"> Home </a></li>
              <li><a href="/mysunshinefamilydental/COVID-19"> COVID-19 </a></li>
              <li><a href="/mysunshinefamilydental/Services"> Services </a></li>
              <li><a href="/mysunshinefamilydental/Forms"> Forms </a></li>
              <li><a href="/mysunshinefamilydental/Insurance"> Insurance </a></li>
              <li><a href="/mysunshinefamilydental/Contact"> Contact </a></li>
            </ul>
          </div>
        </div>
      </Container>
